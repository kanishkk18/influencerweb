...
const SignUpPage = () => {
    return (
      <div className="flex pt-12 min-h-screen flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900">
        ...
        {/* Floating logo/icon above signup */}
        ...
        <div className="relative z-10 w-full max-w-md p-6 md:p-8">
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
            ...
            <div className="mb-6 p-6 pb-0 text-center">
              <h1 className="text-2xl font-bold text-center bg-gradient-to-r from-blue-200 via-indigo-300 to-purple-200 inline-block text-transparent bg-clip-text">
                Join InfluWebHub Today
              </h1>
